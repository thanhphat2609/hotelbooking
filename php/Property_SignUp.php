...
<head>
    ...
    <link rel="stylesheet" href="../css/Property_SignUp.css">
    <title>Sign up</title>
</head>
...
<body>
    <div id="register">
        <div class="register__content">
            <div class="grid wide">
                <nav class="app__nav">
                    <a href="../html/Homepage.php" class="app__nav-name-link">
                    ...
                    <ul class="app__nav-list hide-on-mobile-tablet">
                        ...
                        <li class="app__nav-item">
                            <a href="#" class="app__nav-item-link">Manage Your Stay</a>
                        </li>
                        <li class="app__nav-item">
                            <a href="./Contact.php" class="app__nav-item-link">Contacts</a>
                        </li>
                        <li class="app__nav-item">
                            <a href="./Customer_SignIn.php" class="app__nav-item-link">Sign In</a>
                        </li>
                    </ul>
                </nav>

                <div class="register_main-content">
                    <form action="./HandleInsertPro.php?Insert=1" method="POST" class="form" id="form">
                        <h3 class="form-title">
                            Create An Account
                        </h3>
                        ...
                        <div class="form-group">
                            ...
                            if (isset($_GET['flag'])) {
                                $flag = $_GET['flag'];
                                if ($flag == 1) {
                                    echo "<span class='form-message'>Username đã tồn tại</span>";
                                } else if ($flag == 2) {
                        ...
                        <div class="form-group">
                            ...
                            if (isset($_GET['flag'])) {
                                $flag = $_GET['flag'];
                                if ($flag == 2) {
                                    echo "<span class='form-message'>Gmail đã tồn tại</span>";
                                } else if ($flag == 1) {
                                    echo "<span class='form-message'></span>";
                                }
                            } else {
